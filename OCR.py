...
#Define paths
os.chdir("P:/2020/14/Kodning/Test_scanned_docs_phone_app/Scanned_from_courts/pdftoimage")
pytesseract.pytesseract.tesseract_cmd = "C:/Program Files/Tesseract-OCR/tesseract.exe"
pdf_dir = 'P:/2020/14/Kodning/Test_scanned_docs_phone_app/Scanned_from_courts/pdftoimage'
...
def jpg_to_string(path):
    ...
    for image in path:
        ...
        erosion = cv2.erode(flipped,kernel,iterations = 1)
        
        #Preview image
        cv2.imwrite('processed_img.jpg', erosion)
        img_prev = Image.open('processed_img.jpg')
        img_prev.show() 
        
        custom_config = r'--oem 3 --psm 6'
        img_string = pytesseract.image_to_string(gray, config=custom_config)
