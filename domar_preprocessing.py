...
for file in pdf_files:
    ...
    if len(splitTextOG) > 1: 
        ...
        for i in childNo:
            ...
            if mistakeChilNos is None: # child ID should not start with 197 or 198, or 6,7,8  
                childNoRes.append(i)   
        print(childNoRes)
        ...
        for i in childNoRes:   
            ...
            if vardnInGemensam and 'ska' in findGemensam and 'om' in findGemensam:
                dummyOut = 1
                print("aa1")
            elif vardnInRuling and 'fortsätt' in findGemensam and 'ska' in findGemensam:
                dummyOut = 1
                print("aa2")
            elif vardnInGemensam and 'alltjämt' in findGemensam and 'ska' in findGemensam :
                dummyOut = 1
                print("aa3")
            elif vardnInGemensam and 'skall tillkomma' in findGemensam: 
                dummyOut = 1
                print("aa4")
